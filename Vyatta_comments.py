...
#Create a file which contains commands to execute on device in .txt format and save the file in python directory
with open('vyconfig.txt') as f:
    commands_list = f.read().splitlines()
#Create a file which contains device list/Ip addresses and save the file in python directory
...
#Created dicionary and define values for each items and make sure to select device type as vyos for Vyatta and cisco_ios for Cisco devices
    vyos_12 = {
        'device_type': 'vyos',
